...
export default function QuestionDetailError({
  ...
  return (
    <div className="py-2">
      <div className="rounded-lg border border-[var(--color-state-danger)] bg-[var(--color-surface-base)] p-6">
